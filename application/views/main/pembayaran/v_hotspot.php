        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div id="width-sensor" class="box-body">
                    ...
                    <table id="dg-pembayaran_pelanggan" class="easyui-datagrid" title="Data Pelanggan Hotspot" style="width: 100%;height:397px;" pagination="false" singleSelect="true" toolbar="#toolbar" rownumbers="true" fitColumns="false">
                        <!-- <thead>
                            <tr>
                                <th halign="center" align="center" width="20%" field="kode">ID Pelanggan</th>
                                <th halign="center" align="left" width="35%" field="nama_pelanggan">Nama Pelanggan</th>
                                <th halign="center" align="left" width="25%" field="keterangan">Keterangan</th>
                                <th halign="center" align="right" width="15%" field="tagihan">Total</th>
                            </tr>
                        </thead> -->
                    </table>
                    <div id="toolbar">
